...
const GO_ENTERPRISE: SkillArea = {
  ...
  nodes: [
    ...
    { id: "go-frontend-integration", name: "Integração com Next.js (Frontend)", description: "Go ↔ Next.js 15 nível sênior: contrato tipado fim-a-fim com OpenAPI/Connect-RPC, BFF same-origin, cookies httpOnly com refresh rotation, cache colaborativo (ETag + revalidateTag), streaming SSE/HTTP-2 e erros RFC 7807.", tier: 4, prerequisites: ["go-auth", "go-sdd"], cardSlugs: ["nextjs-go-backend-integration", "go-bff-cors-cookies", "connect-rpc-go-nextjs"] },
    ...
    { id: "go-production-checklist", name: "Checklist de Produção", description: "Critérios de aceite para serviço Go de alto valor: segurança, dados, operação e rollback.", tier: 5, prerequisites: ["go-docker", "go-outbox", "go-performance", "go-auth", "go-frontend-integration"], cardSlugs: ["go-microservice-production-checklist", "container-security", "secrets-management"] },
