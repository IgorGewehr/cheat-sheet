...
const SOFTWARE: SkillArea = {
  ...
  nodes: [
    ...
    { id: "se-performance", name: "Performance & Escalabilidade", description: "Caching, sharding, load balancing, profiling Node.js, N+1, PostgreSQL query tuning.", tier: 3, prerequisites: ["se-observ", "se-arq-dist"], cardSlugs: ["caching-layers", "rate-limit-distribuido", "n-plus-1", "postgres-indexes-explain", "nodejs-profiling", "ai-n-plus-1", "firestore-cost-optimization"] },
