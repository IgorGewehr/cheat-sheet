...
const SOFTWARE: SkillArea = {
  ...
  nodes: [
    ...
    { id: "se-sql", name: "SQL & Bancos Relacionais", description: "DDL/DML, JOINs, índices, transações ACID, normalização.", tier: 0, prerequisites: [] },
    ...
    { id: "se-performance", name: "Performance & Escalabilidade", description: "Caching, sharding, load balancing, profiling, N+1.", tier: 3, prerequisites: ["se-observ", "se-arq-dist"] },
    { id: "se-security", name: "AppSec & OWASP", description: "SAST/DAST, threat modeling, OWASP Top 10 avançado, WAF.", tier: 3, prerequisites: ["se-auth", "se-api"] },
    ...
    { id: "se-iac", name: "Infraestrutura como Código", description: "Terraform, Pulumi, Helm, GitOps, ambientes efêmeros.", tier: 3, prerequisites: ["se-ci-cd", "se-observ"] },

    // ── Tier 4 ──
    { id: "se-staff-arch", name: "Arquitetura Staff-Level", description: "Cross-team design, plataformas internas, golden paths.", tier: 4, prerequisites: ["se-system-design", "se-security"] },
...
const IA_LLM: SkillArea = {
  ...
  nodes: [
    ...
    { id: "ai-transformers", name: "Arquitetura Transformer", description: "Attention, encoder/decoder, positional encoding, tokenização.", tier: 0, prerequisites: [] },
    ...
    { id: "ai-prompt", name: "Prompt Engineering", description: "Zero/few-shot, CoT, sistema vs usuário, jailbreak awareness.", tier: 0, prerequisites: ["ai-transformers"] },

    // ── Tier 1 ──
    { id: "ai-rag", name: "RAG", description: "Retrieval Augmented Generation, chunking, reranking, HyDE.", tier: 1, prerequisites: ["ai-prompt", "ai-alg-lin"] },
    { id: "ai-embeddings", name: "Embeddings & Semântica", description: "Modelos de embedding, índices vetoriais, FAISS, distâncias.", tier: 1, prerequisites: ["ai-transformers", "ai-alg-lin"] },
    ...
    { id: "ai-eval", name: "Avaliação de LLMs", description: "Benchmarks, evals automatizadas, LLM-as-judge, hallucination.", tier: 1, prerequisites: ["ai-prompt", "ai-rag"] },

    // ── Tier 2 ──
    { id: "ai-agents", name: "AI Agents", description: "ReAct, tooling, planning, memória, ciclos de raciocínio.", tier: 2, prerequisites: ["ai-rag", "ai-eval"] },
    { id: "ai-tool-use", name: "Tool Use & Function Calling", description: "Definição de tools, orquestração, streaming, erros.", tier: 2, prerequisites: ["ai-agents"] },
    { id: "ai-vector-db", name: "Vector Databases", description: "Pinecone, Weaviate, pgvector, Qdrant, índices e filtragem.", tier: 2, prerequisites: ["ai-embeddings", "ai-rag"] },
    ...
    // ── Tier 3 ──
    { id: "ai-multi-agent", name: "Sistemas Multi-agente", description: "Orquestração, handoffs, supervisores, crew AI, A2A.", tier: 3, prerequisites: ["ai-agents", "ai-tool-use"] },
    { id: "ai-safety", name: "AI Safety & Alignment", description: "Jailbreaks, red teaming, guardrails, Constitutional AI.", tier: 3, prerequisites: ["ai-eval", "ai-multi-agent"] },
    { id: "ai-prod", name: "LLMs em Produção", description: "Latência, custo, caching, fallbacks, observabilidade, SLOs.", tier: 3, prerequisites: ["ai-multi-agent", "ai-vector-db"] },
    { id: "ai-graph-rag", name: "Graph RAG & Retrieval Avançado", description: "Knowledge graphs, GraphRAG, hybrid search, query decomp.", tier: 3, prerequisites: ["ai-vector-db", "ai-multi-agent"] },

    // ── Tier 4 ──
    { id: "ai-optimization", name: "Otimização de LLMs", description: "Quantização, distilação, vLLM, speculative decoding, batching.", tier: 4, prerequisites: ["ai-prod", "ai-fine-tuning"] },
...
const SECURITY: SkillArea = {
  ...
  nodes: [
    ...
    { id: "sec-incident", name: "Incident Response", description: "Playbooks, containment, forensics, memória, cadeia de custódia.", tier: 3, prerequisites: ["sec-siem", "sec-threat-model"] },
    { id: "sec-zero-trust", name: "Zero Trust Architecture", description: "BeyondCorp, ZTNA, micro-segmentação, identidade como perímetro.", tier: 3, prerequisites: ["sec-devsecops", "sec-auth-adv"] },
...
const DEVOPS: SkillArea = {
  ...
  nodes: [
    ...
    { id: "ops-docker", name: "Docker Fundamentos", description: "Images, containers, Dockerfile, networking básico, volumes.", tier: 0, prerequisites: ["ops-linux"] },

    // ── Tier 1 ──
    { id: "ops-docker-adv", name: "Docker Avançado", description: "Multi-stage builds, compose, registries, build caching, SBOM.", tier: 1, prerequisites: ["ops-docker"] },
    ...
    { id: "ops-ci-cd", name: "CI/CD Pipelines", description: "GitHub Actions, ArgoCD, pipeline as code, blue/green, canary.", tier: 1, prerequisites: ["ops-git", "ops-docker-adv"] },
    { id: "ops-secrets", name: "Secrets Management", description: "Vault, AWS Secrets Manager, SOPS, sealed secrets, rotation.", tier: 1, prerequisites: ["ops-cloud"] },

    // ── Tier 2 ──
    { id: "ops-k8s", name: "Kubernetes", description: "Pods, deployments, services, ingress, RBAC, HPA, operators.", tier: 2, prerequisites: ["ops-docker-adv", "ops-cloud"] },
    { id: "ops-iac", name: "Terraform & IaC", description: "State, modules, workspaces, Terragrunt, policy-as-code (OPA).", tier: 2, prerequisites: ["ops-cloud", "ops-ci-cd"] },
    { id: "ops-observ", name: "Observabilidade", description: "Prometheus, Grafana, Loki, Jaeger, SLIs/SLOs, alertmanager.", tier: 2, prerequisites: ["ops-k8s"] },
    ...
    { id: "ops-finops", name: "FinOps & Cost", description: "Cloud cost analysis, rightsizing, spot instances, savings plans.", tier: 3, prerequisites: ["ops-cloud", "ops-observ"] },
    ...
    { id: "ops-security", name: "Cloud Security", description: "CIS benchmarks, CSPM, image scanning, RBAC hardening, KSPM.", tier: 3, prerequisites: ["ops-iac", "ops-secrets"] },

    // ── Tier 4 ──
    { id: "ops-sre", name: "SRE Avançado", description: "Error budgets, toil reduction, postmortems, reliability roadmap.", tier: 4, prerequisites: ["ops-platform", "ops-chaos", "ops-finops"] },
...
const GOVTECH: SkillArea = {
  ...
  nodes: [
    // ── Tier 0 ──
    { id: "gov-lgpd", name: "LGPD & Privacidade", description: "Bases legais, ANPD, DPIA, consentimento, dados sensíveis.", tier: 0, prerequisites: [], cardSlug: "lgpd-compliance" },
    ...
    { id: "gov-arq", name: "Arquitetura de Sistemas Públicos", description: "Requisitos de continuidade, auditabilidade, multi-instância.", tier: 0, prerequisites: [] },
    { id: "gov-opendata", name: "Open Data & APIs Públicas", description: "Portais de dados, CKAN, padrões de interoperabilidade Gov.", tier: 0, prerequisites: ["gov-arq"] },

    // ── Tier 1 ──
    { id: "gov-nfse", name: "Integração NFS-e / SEFAZ", description: "ABRASF, Nota Fiscal eletrônica, DANFE, contingência, XML.", tier: 1, prerequisites: ["gov-arq", "gov-opendata"], cardSlug: "nfse-abrasf" },
    { id: "gov-keycloak", name: "Keycloak & SSO Gov", description: "Realms, clients, flows customizados, federação LDAP/AD.", tier: 1, prerequisites: ["gov-lgpd", "gov-arq"] },
    { id: "gov-wcag", name: "WCAG & Acessibilidade", description: "WCAG 2.1 AA, VoiceOver, NVDA, tabindex, semântica HTML.", tier: 1, prerequisites: ["gov-arq"], cardSlug: "wcag-acessibilidade" },
    { id: "gov-audit", name: "Trilha de Auditoria", description: "Event log imutável, assinatura, quem fez o quê quando.", tier: 1, prerequisites: ["gov-lgpd", "gov-arq"] },

    // ── Tier 2 ──
    { id: "gov-event-sourcing", name: "Event Sourcing Gov", description: "Aggregate store, projections, audit como efeito colateral.", tier: 2, prerequisites: ["gov-audit", "gov-nfse"] },
    { id: "gov-postgis", name: "PostGIS & GeoDados", description: "Consultas espaciais, shapefile, geocodificação, limites municipais.", tier: 2, prerequisites: ["gov-opendata"] },
    { id: "gov-tce", name: "TCE & Compliance Fiscal", description: "SIAFEM, SIOPE, SIAPC, transparência, relatórios legais.", tier: 2, prerequisites: ["gov-audit", "gov-lgpd"] },
    { id: "gov-multi-tenant", name: "Multi-tenant Municipal", description: "Isolamento de dado por município, schema-per-tenant, CNPJ.", tier: 2, prerequisites: ["gov-keycloak", "gov-event-sourcing"] },

    // ── Tier 3 ──
    { id: "gov-fiscal", name: "FiscalTech Avançado", description: "GNRE, DCTF, EFD-REINF, integrações Receita Federal.", tier: 3, prerequisites: ["gov-nfse", "gov-event-sourcing", "gov-tce"] },
