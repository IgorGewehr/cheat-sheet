...
- **Curvas parametrizadas**: r(t) = (x(t), y(t), z(t)). Vetor tangente r'(t) = (x'(t), y'(t), z'(t)). Comprimento de arco: ∫_a^b |r'(t)| dt. Curvatura κ = |r'×r''|/|r'|³. Curva de Frenet-Serret (tangente T, normal N, binormal B) — base de geometria diferencial.
