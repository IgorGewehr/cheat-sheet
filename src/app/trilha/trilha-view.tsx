...
const NIVEL_META: Record<NivelTrilha, { label: string; color: string; textColor: string; description: string }> = {
  junior: {
    ...
    description: "Fundamentos sólidos: validação, repositórios, auth básica, banco, containers",
  },
  pleno: {
    label: "Pleno",
    color: "bg-emerald-500",
    textColor: "text-emerald-600 dark:text-emerald-400",
    description: "Arquitetura aplicada: monólito modular, DDD leve, clean arch, infra avançada",
  },
  senior: {
    label: "Sênior",
    color: "bg-amber-500",
    textColor: "text-amber-600 dark:text-amber-400",
    description: "Sistemas distribuídos: CQRS, Event-Driven, microsserviços, multi-tenant, compliance",
  },
  staff: {
    label: "Staff",
    color: "bg-violet-500",
    textColor: "text-violet-600 dark:text-violet-400",
    description: "Liderança técnica: multi-filial, IA com auditoria, design de plataformas complexas",
  },
};
